...
При виконанні програми середовище виконання певним чином розміщує збірку. Створюється зв'язок між процесами, доменами додатків і контекстами об'єктів.
...
Домени додатків повністю ізольовані від інших додатків у межах процесу. Враховуючи цей факт, майте на увазі, що програма, яка працює в одному AppDomain, не може отримати будь-які дані (глобальні змінні чи статичні поля) в іншому AppDomain, якщо вони не використовують розподілений протокол програмування.
