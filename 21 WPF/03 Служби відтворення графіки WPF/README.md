...
```
Зображення в могло бути відтворено за допомогою класів Line, Ellipse і Rectangle, показаних раніше. Однак це призвело б до розміщення різних об’єктів UIElement у пам’яті. Коли ви використовуєте геометрію для моделювання точок графіка того, що потрібно намалювати, а потім поміщаєте колекцію геометрії в контейнер, який може відтворювати дані (у цьому випадку Шлях), ви зменшуєте витрати пам’яті.
