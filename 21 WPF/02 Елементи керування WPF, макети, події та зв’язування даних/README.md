...
Маршрутизовані бульбажні події завжди переміщуються від точки походження до наступної визначальної області. Таким чином, у цьому прикладі, якщо ви клацнете об’єкт innerEllipse, подію буде переміщено на Canvas, а не на outerEllipse, оскільки вони обидва є типами Ellipse у межах Canvas.
...
Перша вкладка використовуватиметься, щоб показати загальну роль API цифрового чорнила WPF, який дозволяє вам легко включати в програму функції малювання. Звичайно, аплікація не обов’язково повинна бути буквально аплікацією для малювання; ви можете використовувати цей API для різноманітних цілей, включаючи захоплення рукописного введення.
