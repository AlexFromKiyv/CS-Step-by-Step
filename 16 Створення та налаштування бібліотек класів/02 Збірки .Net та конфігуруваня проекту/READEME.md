...
Програми .NET створюються шляхом збирання з різних частин разом в об’єднання будь-якої кількості збірок. Збірка — це бінарний файл з версіями, що описує себе, і розміщений у середовищі виконання .NET. Формат збірки надає деякі переваги.
...
Повне ім'я типу скаладестья з назви простору імен та назви типу.
