...
C#, як і будь-яка мова програмування, має стандартний набір токенів, які використовуються для виконання основних операцій з внутрішніми типами. Наприклад, ви знаєте, що оператор + можна застосувати до двох цілих чисел, щоб отримати сумму.
