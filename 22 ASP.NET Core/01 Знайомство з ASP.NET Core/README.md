...
Усі ці елементи розглядаються в наступних розділах, за винятком макетів та представлень Razor, які розглядаються в наступній главі.
...
У наступних розділах буде розглянуто багато прикладів домовленостей ASP.NET Core.
