...
Інтерфейси можна визначити як іменований набір абстрактних членів. Вони розглядаються як поведінка типів. Коли різні типи з різниз ієрархій реалізовують один інтерфейс з ними можна працюавти однаковим чином (поліморфізм на базі інтерфейсів). Тип може реалізовувати різні інтерфейси. Можна будувати ієрархії інтерфейсів. Крім того, дозволено створювати інтерфейси, які походять від кількох базових інтерфейсів. 
