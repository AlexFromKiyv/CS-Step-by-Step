...
Рефлексія – це цікавий аспект надійного об'єктно-орієнтованого середовища. У світі .NET ключі до сервісів рефлексії обертаються навколо класу System.Type та простору імен System.Reflection. Як ви бачили, рефлексія — це процес розгляду типу під лупу під час виконання, щоб зрозуміти хто, що, де, коли, чому та як щодо даного елемента.
Пізнє зв'язування — це процес створення екземпляра типу та виклику його членів без попереднього знання конкретних імен цих членів. Пізнє зв'язування часто є прямим результатом динамічного завантаження, яке дозволяє завантажувати збірку .NET у пам'ять програмно. Як показано в прикладі розширюваного застосування в цьому розділі, це потужний метод, який використовується як розробниками інструментів, так і споживачами інструментів.
Також розглянуто роль програмування на основі атрибутів. Коли ви прикрашаєте свої типи атрибутами, результатом є розширення базових метаданих збірки.
Ключове слово dynamic дозволяє визначити дані, ідентичність яких невідома до моменту виконання. Під час обробки середовищем виконання динамічної мови автоматично створене «дерево виразів» буде передано до правильного зв'язувача динамічної мови, де корисне навантаження буде розпаковано та надіслано до правильного члена об'єкта.
Використовуючи динамічні дані та DLR, складні завдання програмування на C# можна радикально спростити, особливо процес інтеграції COM-бібліотек у ваші .NET-додатки.Хоча ці функції, безумовно, можуть спростити ваш код, завжди пам’ятайте, що динамічні дані роблять ваш код C# набагато менш безпечним з точки зору типів та вразливим до помилок під час виконання. Обов’язково зважте всі за і проти використання динамічних даних у ваших проектах C# та протестуйте відповідно!