...
{
    internal partial class RadioEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var hasSubWoofers = runtimeEntityType.AddProperty(
                ...
                sentinel: false);
            hasSubWoofers.TypeMapping = SqlServerBoolTypeMapping.Default.Clone(
            ...
            var hasTweeters = runtimeEntityType.AddProperty(
                ...
                sentinel: false);
            hasTweeters.TypeMapping = SqlServerBoolTypeMapping.Default.Clone(
                comparer: new ValueComparer<bool>(
                    (bool v1, bool v2) => v1 == v2,
                    (bool v) => v.GetHashCode(),
                    (bool v) => v),
            ...
            var radioId = runtimeEntityType.AddProperty(
                ...
                maxLength: 50);
            radioId.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
            ...
            var iX_Radios_InventoryId = runtimeEntityType.AddIndex(
                new[] { carId },
