...
.Net включає в себе велику кількість бібліотек в яких визначенні різноманітні типи. Звязяні по сенсу типи сгрупповані в namespace. Наприклад System.Data namespace містить типи роботи з базами данних. Фундаментальним простором імен є System.
